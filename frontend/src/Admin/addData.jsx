                ...
                <form onSubmit={handleSubmit}>
                    <div className=" grid lg:grid-cols-2 gap-x-10 gap-y-3 lg:gap-y-4 grid-cols-1">
                        ...
                        <div className="">
                            ...
                            <input
                                type="file"
                                className="block w-70 text-xl border border-gray-300 rounded cursor-pointer   file:bg-gray-300 hover:file:bg-gray-400 transition-all file:py-1 file:px-2 bg-gray-50"
